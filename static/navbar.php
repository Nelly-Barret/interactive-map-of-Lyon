    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown">
                <button class="nav-link dropdown-toggle btn btn-default" data-toggle="dropdown" id="dropdownFilters" role="button" aria-expanded="false" aria-controls="dropdown-menu-collapse">
                    Filters
                </button>
