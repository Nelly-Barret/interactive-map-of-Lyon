    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="containerViews" class="containerStyles"><button type="button" class="btn">Streets</button><button type="button" class="btn">Light</button><button type="button" class="btn">Dark</button><button type="button" class="btn">Satellite</button></div>

                <label id="clusterButton" for="containerViews">Map style</label>
                <div id="containerClusters"><input type="radio" id="viewClusters"><label id="clusterButton" for="viewClusters">Clusters</label><input type="radio" id="viewPoints"><label id="clusterButton" for="viewPoints">Points</label></div>
