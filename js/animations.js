...
$(".btnStar").on( 'click', function() {
   ...
   /* we must use +max+1 to convert max as an integer (it is considered by JS as a string) */
...
/* adding br on price buttons when the window is too small, remove it when it's larger */
